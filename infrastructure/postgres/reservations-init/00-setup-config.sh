...
echo "[reservations-init] Copiando configuración pg_hba.conf predefinida..."
cp /docker-entrypoint-initdb.d/pg_hba.conf.template "$PGDATA_DIR/pg_hba.conf"

echo "[reservations-init] Configurando PostgreSQL para replicación..."
...
echo "[reservations-init] Configuración completada. Reiniciando PostgreSQL..."
